    ...
    class TISSheets_Settings {
        ...
        public function add_options_page() {
            if ( current_user_can( 'edit_theme_options' ) ) {
                $this->help_hook = add_options_page( __( 'Theme-Independent Stylesheets', 'theme-independent-stylesheets' ), __( 'Theme-Independent Stylesheets', 'theme-independent-stylesheets' ), 'edit_theme_options', $this->menu_slug, array( $this, 'create_options_page' ) );

                add_action( 'load-' . $this->help_hook, array( $this, 'add_help_tab' ) );
            }
        }
        ...
        /**
         * Settings page help tab
         */
        public function add_help_tab() {
            $screen = get_current_screen();

            $help_sections = array(
                'active'                 => __( 'Active', 'theme-independent-stylesheets' ),
                'load-order'             => __( 'Load Order', 'theme-independent-stylesheets' ),
                'handle'                 => __( 'Handle', 'theme-independent-stylesheets' ),
                'name'                   => __( 'Name', 'theme-independent-stylesheets' ),
                'version'                => __( 'Version', 'theme-independent-stylesheets' ),
                'media-types'            => __( 'Media Type(s)', 'theme-independent-stylesheets' ),
                'external-or-inline'     => __( 'External or Inline?', 'theme-independent-stylesheets' ),
                'ie-conditional-comment' => __( 'IE Conditional Comment', 'theme-independent-stylesheets' ),
            );

            foreach ( $help_sections as $handle => $title ) {
                ob_start();
                require_once( TISSHEETS_HELP . 'help-' . $handle . '.php' );
        ...
        public function create_options_page() {
            ...
            <div class="wrap">
                ...
                <form method="post" action="options.php">
                    ...
                    <h2><?php _e( 'Stylesheet Settings', 'theme-independent-stylesheets' ); ?></h2>
                    <?php
                        ...
                        <tbody>
                            ...
                            if ( $stylesheets ) {
                                ...
                                foreach( $stylesheets as $stylesheet ) {
                                    ...
                                    // TODO - Remove this column and add drag/drop fuctionality to table rows
